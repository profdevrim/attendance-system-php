...
?>
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">Attandence Detail</a></li>
			</ul>
...
<?php if($_SESSION['role']  != 0){ ?>
			<div class="row-fluid">	
				<div class="box blue span12">
					<div class="box-header">
						<h2><i class="halflings-icon user"></i><span class="break"></span>Quick Employee</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon remove"></i></a>
						</div>
...
<?php 
	...
	while($rows_EMP = mysqli_fetch_array($query_EMP)){ 		
		...
		?>
						...
						<a class="quick-button span2" href='rpt_user_detail.php?uid=<?php echo base64_encode($rows_EMP['username']); ?>'>
							<i class="icon-user"></i>
			...
			<div class="row-fluid ">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon file"></i><span class="break"></span>Attandence Detail Report ( <?php
...
<?php
	...
	inner join attendance on attandance_master.master_id = attendance.master_id 
	inner join employee on employee.username = attandance_master.emp where username='".base64_decode($_GET['uid'])."'";
